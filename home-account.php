            ...
            <div class="block" id="records">
                <table>
                    ...
                    <tbody>
                        <?php
                        $year = date("Y");
                        $result_list = sql_query("SELECT day, category, name, money FROM account WHERE YEAR(day) = $year ORDER BY day DESC LIMIT 25;");
                        while($row = mysqli_fetch_assoc($result_list)) {
                            if($row['category'] == "pocket money") {
